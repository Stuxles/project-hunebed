                    ...
                    <div class="row">
                        <ul class="collection with-header">
                            ...
                            <li class="collection-item">
                                <div>Naam: Joapie <a href="#!" class="secondary-content"><i class="material-icons">send</i></a></div>
                            </li>
                            <li class="collection-item">
                                <div>E-mail adres: Jjakkerman@hunebedcentrum.nl<a href="#!" class="secondary-content"><i class="material-icons">send</i></a></div>
                            </li>
                            <li class="collection-item">
                                <div>functie: Horeca<a href="#!" class="secondary-content"><i class="material-icons">send</i></a></div>
                            </li>
                            <li class="collection-item">
