            ...
            <div class="row">
                <form class="col s12">
                    ...
                    <div class="row center">
                        <a href="<?= base_url('moderator/moderator') ?>" class="btn waves-effect hb-red-bg waves-light"><i class="material-icons left" id="terug">arrow_back</i>Terug</a>
                    ...
                    <div id="modal1" class="modal">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="#modal2" class="modal-close waves-effect hb-blue btn modal-trigger">Nog een vraag toevoegen</a>
